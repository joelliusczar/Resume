...
\workProj{A classic car insurance company}{I contributed to their public web application using a combination of C\#, SQL, and AngularJS and was a part of the transition to a new platform that they released for their insurance quote website.\newline
...
\workProj{A regional pork and poultry distributor }{Using VB.Net and Telerik WinForms, I helped upgrade a VB6 application to VB.Net. My team wrote specific applications to automate much of the update by using specialized find and replace with regular expressions.}
}
%----------------------------------------------------------------------------------------
%	EDUCATION SECTION
%----------------------------------------------------------------------------------------
...
% \skillrow{C\#}{JavaScript}{Objective-C}
% \skillrow{SQL}{Entity Framework}{HTML/CSS}
% \skillrow{Java}{Regular Expressions (RegExp)}{ASP.Net (MVC)}
